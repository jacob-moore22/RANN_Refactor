...
#ifdef COMMAND_CLASS
// clang-format off
CommandStyle(replica/atom/swap/npt,ReplicaAtomSwapNPT);
// clang-format on
#else

#ifndef LMP_REPLICA_ATOM_SWAP_NPT_H
#define LMP_REPLICA_ATOM_SWAP_NPT_H

#include "command.h"

namespace LAMMPS_NS {

class ReplicaAtomSwapNPT : public Command {
 public:
  ReplicaAtomSwapNPT(class LAMMPS *);
  ~ReplicaAtomSwapNPT() override;
 ...
 private:
  ...
  double vol_stored,vol_stored_partner;
