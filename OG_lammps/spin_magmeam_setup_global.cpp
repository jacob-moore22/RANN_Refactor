...
void
MAGMEAM::meam_setup_global(int nelt, lattice_t* lat, int* ielement, double* /*atwt*/, double* alpha,
                        ...
                        int* ibar)
{
  ...
  setall3d(this->Cmax_magmeam, 2.8);
  setall3d(this->Cmin_magmeam, 2.0);
  setall3d(this->Cmax_magpair, 2.8);
  setall3d(this->Cmin_magpair, 2.0);
  ...
  for (i = 0; i < nelt; i++) {
	...
	this->mag_re[i][j] = 0.0;
	this->mag_attrac[i][j] = 0.0;
	this->mag_repuls[i][j] = 0.0;
    }
