...
State_spinjscreened::State_spinjscreened(PairRANN* _pair) : State(_pair)
{
    n_body_type = 2;
    dr              = 0;
    re              = 0;
...
State_spinjscreened::~State_spinjscreened()
{
    delete[] atomtypes;
    delete[] spintable;
    delete[] spindtable;
...
void State_spinjscreened::init(int* i, int _id)
{
    empty = false;
...
///
/////////////////////////////////////////////////////////////////////////////
void State_spinjscreened::eos_function(double* ep, double** force, double** fm, double* Sik, double* dSikx,
...
///
/////////////////////////////////////////////////////////////////////////////
bool State_spinjscreened::parse_values(std::string constant, std::vector<std::string> line1)
{
    int l;
...
///
/////////////////////////////////////////////////////////////////////////////
void State_spinjscreened::generate_spin_table()
{
    int    buf = 5;
    int    m;
...
///
/////////////////////////////////////////////////////////////////////////////
void State_spinjscreened::write_values(FILE* fid)
{
    int i;
